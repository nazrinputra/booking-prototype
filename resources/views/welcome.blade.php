            ...
            <div class="row">
                ...
                <div class="col-lg-10 offset-lg-1">
                    <ul class="categories">
                        ...
                        <li><a href="/listing"><span class="icon"><img src="assets/images/search-icon-02.png"
                                        alt="Food"></span> Food &amp; Life</a></li>
                        <li><a href="#"><span class="icon"><img src="assets/images/search-icon-03.png"
                                        alt="Vehicle"></span> Cars</a></li>
                        <li><a href="#"><span class="icon"><img src="assets/images/search-icon-04.png"
                                        alt="Shopping"></span> Shopping</a></li>
                        <li><a href="#"><span class="icon"><img src="assets/images/search-icon-05.png"
                                        alt="Travel"></span> Traveling</a></li>
                    </ul>
                </div>
            </div>
        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-5 align-self-center">
                                                            <div class="left-text">
                                                                ...
                                                                <div class="main-white-button"><a href="/listing"><i
                                                                            class="fa fa-eye"></i>
                                                                        More Listing</a></div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-5 align-self-center">
                                                            <div class="left-text">
                                                                ...
                                                                <p>Image credits go to Unsplash website that provides
                                                                    free stock photos for anyone. Images used in this
                                                                    Plot Listing template are from Unsplash.</p>
                                                                <div class="main-white-button"><a href="#"><i
                                                                            class="fa fa-eye"></i> Discover More</a>
                                                                </div>
                                                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="listing-item">
                                        ...
                                        <div class="right-content align-self-center">
                                            ...
                                            <ul class="info">
                                                <li><img src="assets/images/listing-icon-02.png" alt=""> 4
                                                    Bedrooms</li>
                                                <li><img src="assets/images/listing-icon-03.png" alt=""> 4
                                                    Bathrooms</li>
                                            </ul>
                                    ...
                                    <div class="listing-item">
                                        ...
                                        <div class="right-content align-self-center">
                                            ...
                                            <ul class="info">
                                                <li><img src="assets/images/listing-icon-02.png" alt=""> 4
                                                    Bedrooms</li>
                                                <li><img src="assets/images/listing-icon-03.png" alt=""> 3
                                                    Bathrooms</li>
                                            </ul>
                                            <div class="main-white-button">
                                                <a href="/contact"><i class="fa fa-eye"></i> Contact Now</a>
                                ...
                                <div class="col-lg-12">
                                    <div class="listing-item">
                                        ...
                                        <div class="right-content align-self-center">
                                            ...
                                            <ul class="info">
                                                <li><img src="assets/images/listing-icon-02.png" alt=""> 5
                                                    Bedrooms</li>
                                                <li><img src="assets/images/listing-icon-03.png" alt=""> 3
                                                    Bathrooms</li>
                                            </ul>
                                ...
                                <div class="col-lg-12">
                                    <div class="listing-item">
                                        ...
                                        <div class="right-content align-self-center">
                                            ...
                                            <ul class="info">
                                                <li><img src="assets/images/listing-icon-02.png" alt=""> 6
                                                    Bedrooms</li>
                                                <li><img src="assets/images/listing-icon-03.png" alt=""> 3
                                                    Bathrooms</li>
                                            </ul>
                                ...
                                <div class="col-lg-12">
                                    <div class="listing-item">
                                        ...
                                        <div class="right-content align-self-center">
                                            ...
                                            <ul class="info">
                                                <li><img src="assets/images/listing-icon-02.png" alt=""> 8
                                                    Bedrooms</li>
                                                <li><img src="assets/images/listing-icon-03.png" alt=""> 5
                                                    Bathrooms</li>
                                            </ul>
                                            <div class="main-white-button">
                                                <a href="/contact"><i class="fa fa-eye"></i> Contact Now</a>
